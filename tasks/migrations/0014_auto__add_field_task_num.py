...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.num'
        db.add_column(u'tasks_task', 'num',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.num'
        db.delete_column(u'tasks_task', 'num')
    ...
    models = {
        ...
        u'tasks.task': {
            ...
            'num': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
