...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'tasks_graph', (
            ...
            ('fancy', self.gf('django.db.models.fields.DateTimeField')(null=True)),
    ...
    models = {
        ...
        u'tasks.task': {
            ...
            'prevs': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'prevs_s'", 'symmetrical': 'False', 'to': u"orm['tasks.Task']"}),
