...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Active.task'
        db.add_column(u'tasks_active', 'task',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='abc', to=orm['tasks.Task']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Active.task'
        db.delete_column(u'tasks_active', 'task_id')
    ...
    models = {
        ...
        u'tasks.active': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'default': "'abc'", 'to': u"orm['tasks.Task']"}),
