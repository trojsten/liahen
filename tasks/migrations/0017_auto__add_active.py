...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tasks_active', (
            ...
            ('task_set', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('task_set_style', self.gf('django.db.models.fields.CharField')(default='G', max_length=1)),
        ))
        db.send_create_signal(u'tasks', ['Active'])

        # Removing M2M table for field actives on 'TaskSet'
        db.delete_table(db.shorten_name(u'tasks_taskset_actives'))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field actives on 'TaskSet'
        m2m_table_name = db.shorten_name(u'tasks_taskset_actives')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('taskset', models.ForeignKey(orm[u'tasks.taskset'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['taskset_id', 'user_id'])
    ...
    models = {
        ...
        u'tasks.active': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'task_set': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
