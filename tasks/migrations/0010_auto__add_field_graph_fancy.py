...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Graph.fancy'
        db.add_column(u'tasks_graph', 'fancy',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Graph.fancy'
        db.delete_column(u'tasks_graph', 'fancy')
    ...
    models = {
        ...
        u'tasks.graph': {
            ...
            'fancy': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tasks.task': {
            ...
            'edges': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'nexts'", 'symmetrical': 'False', 'through': u"orm['tasks.Graph']", 'to': u"orm['tasks.Task']"}),
