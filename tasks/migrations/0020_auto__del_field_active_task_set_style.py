...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Active.task_set_style'
        db.delete_column(u'tasks_active', 'task_set_style')


    def backwards(self, orm):
        # Adding field 'Active.task_set_style'
        db.add_column(u'tasks_active', 'task_set_style',
