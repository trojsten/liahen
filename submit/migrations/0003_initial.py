...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'submit_submit', (
            ...
            ('message', self.gf('django.db.models.fields.CharField')(default='In testing queue...', max_length=256)),
    ...
    models = {
        ...
        u'submit.submit': {
            ...
            'message': ('django.db.models.fields.CharField', [], {'default': "'In testing queue...'", 'max_length': '256'}),
