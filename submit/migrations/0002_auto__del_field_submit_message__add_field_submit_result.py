...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Submit.message'
        db.delete_column(u'submit_submit', 'message')

        # Adding field 'Submit.result'
        db.add_column(u'submit_submit', 'result',
                      self.gf('django.db.models.fields.CharField')(default='IQ', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Submit.message'
        db.add_column(u'submit_submit', 'message',
                      self.gf('django.db.models.fields.CharField')(default='IQ', max_length=256),
                      keep_default=False)

        # Deleting field 'Submit.result'
        db.delete_column(u'submit_submit', 'result')
    ...
    models = {
        ...
        u'submit.submit': {
            ...
            'result': ('django.db.models.fields.CharField', [], {'default': "'IQ'", 'max_length': '20'}),
